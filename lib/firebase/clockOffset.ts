...
// une fois par session au login (voir loadGameAndClockOffsetFromFirestore dans
// saveGame.ts) puis réutilisé en mémoire pour tous les `savedAt`/`lastSaved`
// de la session — sans repayer un aller-retour réseau à chaque sauvegarde.

...
export const ITEM_DEFS: Record<string, ItemDef> = {
  elixir_vie: {
    ...
    description: "Débloque la 1ère évolution de Sung Jin Woo — aussi requis (en plus des suivants) pour ses évolutions ultérieures.",
    sellGems: 100,
  },
  manteau_ombre: {
    id: 'manteau_ombre', name: "Manteau de l'Ombre", icon: '🧥', color: '#818cf8',
    description: "Débloque la 2ème évolution de Sung Jin Woo, en plus de l'Élixir de Vie — aussi requis pour l'évolution finale.",
    sellGems: 100,
  },
  beru: {
    id: 'beru', name: 'Beru', icon: '🐜', color: '#a855f7',
    description: "Débloque l'évolution finale de Sung Jin Woo, en plus de l'Élixir de Vie et du Manteau de l'Ombre.",
    sellGems: 100,
  },
  cristal_ether: {
    id: 'cristal_ether', name: 'Cristal d’Éther', icon: '💎', color: '#38bdf8',
    description: 'Débloque la 1ère évolution d’Arthur Leywin — aussi requis (en plus des suivants) pour ses évolutions ultérieures.',
    sellGems: 100,
  },
  epee_ether: {
    id: 'epee_ether', name: 'Épée d’Éther', icon: '⚔️', color: '#f59e0b',
    description: 'Débloque la 2ème évolution d’Arthur Leywin, en plus du Cristal d’Éther — aussi requise pour l’évolution finale.',
    sellGems: 100,
  },
  sylvia: {
    id: 'sylvia', name: 'Sylvia', icon: '👑', color: '#f97316',
    description: 'Débloque l’évolution finale d’Arthur Leywin, en plus du Cristal d’Éther et de l’Épée d’Éther.',
    sellGems: 100,
  },
  masque_cid: {
...
export const EQUIPMENT_DEFS: Record<string, EquipmentDef> = {
  ...
  helmet_common: {
    ...
    description:'Casque robuste pour les débutants.', dpsMultiplier:RARITY_BASE_MULT.C,
  },
  helmet_uncommon: {
    id: 'helmet_uncommon', name: 'Casque Peu Commun', slot:'helmet', rarity:'U', icon:'🧢', color:'#4ade80',
    description:'Casque amélioré pour les aventuriers expérimentés.', dpsMultiplier:RARITY_BASE_MULT.U,
  },
  helmet_rare: {
    id: 'helmet_rare', name: 'Casque Rare', slot:'helmet', rarity:'R', icon:'🪖', color:'#60a5fa',
    description:'Casque plus résistant et élégant.', dpsMultiplier:RARITY_BASE_MULT.R,
  },
  helmet_epic: {
    id: 'helmet_epic', name: 'Casque Épique', slot:'helmet', rarity:'E', icon:'🥽', color:'#c084fc',
    description:'Casque enchanté aux propriétés offensives.', dpsMultiplier:RARITY_BASE_MULT.E,
  },
  helmet_legendary: {
    id: 'helmet_legendary', name: 'Casque Légendaire', slot:'helmet', rarity:'L', icon:'🥷', color:'#fbbf24',
    description:'Casque mythique issu des batailles anciennes.', dpsMultiplier:RARITY_BASE_MULT.L,
  },
  helmet_mythique: {
    id: 'helmet_mythique', name: 'Casque Mythique', slot:'helmet', rarity:'M', icon:'👺', color:'#f87171',
    description:'Casque forgé selon des légendes oubliées.', dpsMultiplier:RARITY_BASE_MULT.M,
  },
  helmet_stellar: {
    id: 'helmet_stellar', name: 'Casque Stellaire', slot:'helmet', rarity:'S', icon:'💫', color:'#e2e8f0',
    description:'Casque taillé dans la poussière d’étoiles.', dpsMultiplier:RARITY_BASE_MULT.S,
  },
  helmet_cosmic: {
    id: 'helmet_cosmic', name: 'Casque Cosmique', slot:'helmet', rarity:'CO', icon:'🌠', color:'#34d399',
    description:'Casque imprégné de l’énergie du cosmos.', dpsMultiplier:RARITY_BASE_MULT.CO,
  },
  helmet_primordial: {
    id: 'helmet_primordial', name: 'Casque Primordial', slot:'helmet', rarity:'P', icon:'👑', color:'#ff6b35',
    description:'Casque porté par les premiers héros.', dpsMultiplier:RARITY_BASE_MULT.P,
  },
  helmet_transcendant: {
    id: 'helmet_transcendant', name: 'Casque Transcendant', slot:'helmet', rarity:'T', icon:'😈', color:'#e879f9',
    description:'Casque ayant dépassé les limites du mortel.', dpsMultiplier:RARITY_BASE_MULT.T,
  },

  // Plastrons
  chest_common: {
    id: 'chest_common', name: 'Plastron Commun', slot:'chest', rarity:'C', icon:'🛡', color:'#9ca3af',
    description:'Plastron léger et fiable.', dpsMultiplier:RARITY_BASE_MULT.C,
  },
  chest_uncommon: {
    id: 'chest_uncommon', name: 'Plastron Peu Commun', slot:'chest', rarity:'U', icon:'🦺', color:'#4ade80',
    description:'Plastron amélioré, mieux protégé.', dpsMultiplier:RARITY_BASE_MULT.U,
  },
  chest_rare: {
    id: 'chest_rare', name: 'Plastron Rare', slot:'chest', rarity:'R', icon:'🦺', color:'#60a5fa',
    description:'Plastron renforcé contre les dégâts.', dpsMultiplier:RARITY_BASE_MULT.R,
  },
  chest_epic: {
    id: 'chest_epic', name: 'Plastron Épique', slot:'chest', rarity:'E', icon:'🥼', color:'#c084fc',
    description:'Plastron chargé de magie offensive.', dpsMultiplier:RARITY_BASE_MULT.E,
  },
  chest_legendary: {
    id: 'chest_legendary', name: 'Plastron Légendaire', slot:'chest', rarity:'L', icon:'🛡️', color:'#fbbf24',
    description:'Plastron des champions légendaires.', dpsMultiplier:RARITY_BASE_MULT.L,
  },
  chest_mythique: {
    id: 'chest_mythique', name: 'Plastron Mythique', slot:'chest', rarity:'M', icon:'🥋', color:'#f87171',
    description:'Plastron né d’un mythe ancien.', dpsMultiplier:RARITY_BASE_MULT.M,
  },
  chest_stellar: {
    id: 'chest_stellar', name: 'Plastron Stellaire', slot:'chest', rarity:'S', icon:'🌌', color:'#e2e8f0',
    description:'Plastron scintillant comme une nébuleuse.', dpsMultiplier:RARITY_BASE_MULT.S,
  },
  chest_cosmic: {
    id: 'chest_cosmic', name: 'Plastron Cosmique', slot:'chest', rarity:'CO', icon:'🌠', color:'#34d399',
    description:'Plastron parcouru par l’énergie du cosmos.', dpsMultiplier:RARITY_BASE_MULT.CO,
  },
  chest_primordial: {
    id: 'chest_primordial', name: 'Plastron Primordial', slot:'chest', rarity:'P', icon:'🛡️', color:'#ff6b35',
    description:'Plastron imprégné de l’énergie primordiale.', dpsMultiplier:RARITY_BASE_MULT.P,
  },
  chest_transcendant: {
    id: 'chest_transcendant', name: 'Plastron Transcendant', slot:'chest', rarity:'T', icon:'🔱', color:'#e879f9',
    description:'Plastron ayant dépassé les limites du mortel.', dpsMultiplier:RARITY_BASE_MULT.T,
  },
  chest_primordial_cid: {
    id: 'chest_primordial_cid', name: "Manteau de l'Éminence de l'Ombre", slot:'chest', rarity:'CO', icon:'🧥', color:'#a78bfa',
    description:"Le manteau de celui qui se tapit dans l'ombre. Bonus si équipé par Cid Kagenou.", dpsMultiplier:RARITY_BASE_MULT.CO,
  ...
  pants_common: {
    ...
    description:'Pantalon de voyage ordinaire.', dpsMultiplier:RARITY_BASE_MULT.C,
  },
  pants_uncommon: {
    id: 'pants_uncommon', name: 'Pantalon Peu Commun', slot:'pants', rarity:'U', icon:'🩳', color:'#4ade80',
    description:'Pantalon amélioré pour plus de mobilité.', dpsMultiplier:RARITY_BASE_MULT.U,
  },
  pants_rare: {
    id: 'pants_rare', name: 'Pantalon Rare', slot:'pants', rarity:'R', icon:'🩳', color:'#60a5fa',
    description:'Pantalon renforcé pour l’agilité.', dpsMultiplier:RARITY_BASE_MULT.R,
  },
  pants_epic: {
    id: 'pants_epic', name: 'Pantalon Épique', slot:'pants', rarity:'E', icon:'👖', color:'#c084fc',
    description:'Pantalon mystique qui améliore les mouvements.', dpsMultiplier:RARITY_BASE_MULT.E,
  },
  pants_legendary: {
    id: 'pants_legendary', name: 'Pantalon Légendaire', slot:'pants', rarity:'L', icon:'👖', color:'#fbbf24',
    description:'Pantalon des sages de bataille.', dpsMultiplier:RARITY_BASE_MULT.L,
  },
  pants_mythique: {
    id: 'pants_mythique', name: 'Pantalon Mythique', slot:'pants', rarity:'M', icon:'👖', color:'#f87171',
    description:'Pantalon issu d’une légende oubliée.', dpsMultiplier:RARITY_BASE_MULT.M,
  },
  pants_stellar: {
    id: 'pants_stellar', name: 'Pantalon Stellaire', slot:'pants', rarity:'S', icon:'👖', color:'#e2e8f0',
    description:'Pantalon tissé de lumière stellaire.', dpsMultiplier:RARITY_BASE_MULT.S,
  },
  pants_cosmic: {
    id: 'pants_cosmic', name: 'Pantalon Cosmique', slot:'pants', rarity:'CO', icon:'👖', color:'#34d399',
    description:'Pantalon chargé de l’énergie du cosmos.', dpsMultiplier:RARITY_BASE_MULT.CO,
  },
  pants_primordial: {
    id: 'pants_primordial', name: 'Pantalon Primordial', slot:'pants', rarity:'P', icon:'👖', color:'#ff6b35',
    description:'Pantalon chargé d’une force ancienne.', dpsMultiplier:RARITY_BASE_MULT.P,
  },
  pants_transcendant: {
    id: 'pants_transcendant', name: 'Pantalon Transcendant', slot:'pants', rarity:'T', icon:'👖', color:'#e879f9',
    description:'Pantalon ayant dépassé les limites du mortel.', dpsMultiplier:RARITY_BASE_MULT.T,
  },

  // Bottes
  boots_common: {
    id: 'boots_common', name: 'Bottes Communes', slot:'boots', rarity:'C', icon:'🥾', color:'#9ca3af',
    description:'Bottes simples pour marcher plus vite.', dpsMultiplier:RARITY_BASE_MULT.C,
  },
  boots_uncommon: {
    id: 'boots_uncommon', name: 'Bottes Peu Communes', slot:'boots', rarity:'U', icon:'🥾', color:'#4ade80',
    description:'Bottes améliorées pour le combat.', dpsMultiplier:RARITY_BASE_MULT.U,
  },
  boots_rare: {
    id: 'boots_rare', name: 'Bottes Rares', slot:'boots', rarity:'R', icon:'🥾', color:'#60a5fa',
    description:'Bottes équilibrées pour le combat.', dpsMultiplier:RARITY_BASE_MULT.R,
  },
  boots_epic: {
    id: 'boots_epic', name: 'Bottes Épiques', slot:'boots', rarity:'E', icon:'🥾', color:'#c084fc',
    description:'Bottes enchantées pour l’élan.', dpsMultiplier:RARITY_BASE_MULT.E,
  },
  boots_legendary: {
    id: 'boots_legendary', name: 'Bottes Légendaires', slot:'boots', rarity:'L', icon:'🥾', color:'#fbbf24',
    description:'Bottes des héros des âges anciens.', dpsMultiplier:RARITY_BASE_MULT.L,
  },
  boots_mythique: {
    id: 'boots_mythique', name: 'Bottes Mythiques', slot:'boots', rarity:'M', icon:'🥾', color:'#f87171',
    description:'Bottes tirées d’un mythe oublié.', dpsMultiplier:RARITY_BASE_MULT.M,
  },
  boots_stellar: {
    id: 'boots_stellar', name: 'Bottes Stellaires', slot:'boots', rarity:'S', icon:'🥾', color:'#e2e8f0',
    description:'Bottes qui foulent la poussière d’étoiles.', dpsMultiplier:RARITY_BASE_MULT.S,
  },
  boots_cosmic: {
    id: 'boots_cosmic', name: 'Bottes Cosmiques', slot:'boots', rarity:'CO', icon:'🥾', color:'#34d399',
    description:'Bottes chargées de l’énergie du cosmos.', dpsMultiplier:RARITY_BASE_MULT.CO,
  },
  boots_primordial: {
    id: 'boots_primordial', name: 'Bottes Primordiales', slot:'boots', rarity:'P', icon:'🥾', color:'#ff6b35',
    description:'Bottes imprégnées d’une force primale.', dpsMultiplier:RARITY_BASE_MULT.P,
  },
  boots_transcendant: {
    id: 'boots_transcendant', name: 'Bottes Transcendantes', slot:'boots', rarity:'T', icon:'🥾', color:'#e879f9',
    description:'Bottes ayant dépassé les limites du mortel.', dpsMultiplier:RARITY_BASE_MULT.T,
  },

  // Armes génériques
  weapon_common: {
    id: 'weapon_common', name: 'Arme Commune', slot:'weapon', rarity:'C', icon:'🗡', color:'#9ca3af',
    description:'Une arme simple, mais efficace.', dpsMultiplier:RARITY_BASE_MULT.C,
  },
  weapon_uncommon: {
    id: 'weapon_uncommon', name: 'Arme Peu Commune', slot:'weapon', rarity:'U', icon:'⚔', color:'#4ade80',
    description:'Une arme améliorée, déjà redoutable.', dpsMultiplier:RARITY_BASE_MULT.U,
  },
  weapon_rare: {
    id: 'weapon_rare', name: 'Arme Rare', slot:'weapon', rarity:'R', icon:'⚔', color:'#60a5fa',
    description:'Arme qui tranche avec précision.', dpsMultiplier:RARITY_BASE_MULT.R,
  },
  weapon_epic: {
    id: 'weapon_epic', name: 'Arme Épique', slot:'weapon', rarity:'E', icon:'🗡️', color:'#c084fc',
    description:'Arme imprégnée d’énergie mystique.', dpsMultiplier:RARITY_BASE_MULT.E,
  },
  weapon_legendary: {
    id: 'weapon_legendary', name: 'Arme Légendaire', slot:'weapon', rarity:'L', icon:'🗡️', color:'#fbbf24',
    description:'Arme qui a traversé les légendes.', dpsMultiplier:RARITY_BASE_MULT.L,
  },
  weapon_mythique: {
    id: 'weapon_mythique', name: 'Arme Mythique', slot:'weapon', rarity:'M', icon:'🗡️', color:'#f87171',
    description:'Arme sortie tout droit d’un mythe oublié.', dpsMultiplier:RARITY_BASE_MULT.M,
  },
  weapon_stellar: {
    id: 'weapon_stellar', name: 'Arme Stellaire', slot:'weapon', rarity:'S', icon:'🌟', color:'#e2e8f0',
    description:'Arme forgée dans la matière des étoiles.', dpsMultiplier:RARITY_BASE_MULT.S,
  },
  weapon_cosmic: {
    id: 'weapon_cosmic', name: 'Arme Cosmique', slot:'weapon', rarity:'CO', icon:'☄️', color:'#34d399',
    description:'Arme chargée de l’énergie du cosmos.', dpsMultiplier:RARITY_BASE_MULT.CO,
  },
  weapon_primordial: {
    id: 'weapon_primordial', name: 'Arme Primordiale', slot:'weapon', rarity:'P', icon:'⚔️', color:'#ff6b35',
    description:'Arme ancestrale dotée d’un pouvoir brut.', dpsMultiplier:RARITY_BASE_MULT.P,
  },
  weapon_transcendant_generic: {
    id: 'weapon_transcendant_generic', name: 'Arme Transcendante', slot:'weapon', rarity:'T', icon:'⚡', color:'#e879f9',
    description:'Arme ayant dépassé les limites du mortel.', dpsMultiplier:RARITY_BASE_MULT.T,
  },
  ...
  weapon_transcendant_griffon: {
    ...
    description:"Une arme légendaire à la puissance du Roi. Bonus si équipé par Shanks.", dpsMultiplier:RARITY_BASE_MULT.T,
  ...
  weapon_primordial_aatrox: {
    ...
    description:"Une lame maudite scellant un seigneur Darkin. Bonus si équipé par Aatrox.", dpsMultiplier:RARITY_BASE_MULT.P,
  ...
  weapon_primordial_hogyoku: {
    ...
    description:"L'orbe interdit qui efface les frontières entre Hollow et Shinigami. Bonus si équipé par Aizen Transcendant.", dpsMultiplier:RARITY_BASE_MULT.P,
  ...
  weapon_primordial_dawn: {
    ...
    description:"L'arme sacrée forgée à l'aurore des temps. Bonus si équipée par Arthur Leywin.", dpsMultiplier:RARITY_BASE_MULT.P,
  ...
  weapon_primordial_benimaru: {
    ...
    description:"L'étendard des pompiers de la 8ème Brigade. Bonus si équipé par Benimaru.", dpsMultiplier:RARITY_BASE_MULT.P,
  ...
  weapon_primordial_brunhilde: {
    ...
    description:"Une relique dont la nature reste un mystère. Bonus si équipé par Brunhilde.", dpsMultiplier:RARITY_BASE_MULT.P,
  ...
  weapon_primordial_dva: {
    ...
    description:"Le mécha de combat personnel de D.Va. Bonus si équipé par D.Va.", dpsMultiplier:RARITY_BASE_MULT.P,
  ...
  weapon_primordial_eren: {
    ...
    description:"Des lances capables de percer la nuque des Titans. Bonus si équipé par Eren.", dpsMultiplier:RARITY_BASE_MULT.P,
  ...
  chest_primordial_gi_fusion: {
    ...
    description:"Le vêtement porté lors des fusions les plus puissantes de l'univers. Bonus si équipé par Gogeta.", dpsMultiplier:RARITY_BASE_MULT.P,
  ...
  weapon_primordial_magic: {
    ...
    description:'Bonus si équipé par Goku.', dpsMultiplier:RARITY_BASE_MULT.P,
  ...
  weapon_primordial_antidepresseur: {
    ...
    description:"Un remède à la mélancolie... ou une arme redoutable. Bonus si équipé par Ouchuu.", dpsMultiplier:RARITY_BASE_MULT.P,
  ...
  weapon_primordial_theknight: {
    ...
    description:"Le clou aiguisé qui a percé mille adversaires. Bonus si équipé par The Knight.", dpsMultiplier:RARITY_BASE_MULT.P,
  ...
  weapon_cosmic_aizen: {
    ...
    description:"Le zanpakuto illusionniste d'Aizen. Bonus si équipé par Aizen.", dpsMultiplier:RARITY_BASE_MULT.CO,
  ...
  weapon_cosmic_gilgamesh: {
    ...
    description:'Bonus si équipé par Gilgamesh.', dpsMultiplier:RARITY_BASE_MULT.CO,
  ...
  weapon_cosmic_shinra: {
    ...
    description:"La flamme adorable qui embrase les Infernaux. Bonus si équipé par Shinra.", dpsMultiplier:RARITY_BASE_MULT.CO,
  ...
  weapon_cosmic_jinwoo: {
    ...
    description:'Bonus si équipé par Jinwoo.', dpsMultiplier:RARITY_BASE_MULT.CO,
  ...
  weapon_cosmic_vegeta: {
    ...
    description:'Bonus si équipé par Végéta.', dpsMultiplier:RARITY_BASE_MULT.CO,
  ...
  weapon_cosmic_pourfenda: {
    ...
    description:"Une lame sombre qui tranche l'espace lui-même. Bonus si équipé par Yami.", dpsMultiplier:RARITY_BASE_MULT.CO,
  ...
  weapon_cosmic_zorua: {
    ...
    description:"Une ball rare parfaite pour capturer les illusionnistes. Bonus si équipé par Zorua.", dpsMultiplier:RARITY_BASE_MULT.CO,
...
const EQUIP_RARITY_WEIGHT: Record<string, number> = {
  C: 33, U: 1, R: 0.5, E: 0.2, L: 0.1, M: 0.05, S: 0.025, CO: 0.0125, P: 0.00625, T: 0.003125,
};

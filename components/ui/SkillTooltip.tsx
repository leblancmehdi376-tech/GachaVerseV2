  ...
  const tooltipContent = (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 5 }}>
        ...
        <span style={{ fontFamily: 'var(--f-ui)', fontWeight: 800, fontSize: 12, letterSpacing: 0.5, color: '#c084fc', textShadow: '0 0 10px rgba(192,132,252,0.6)' }}>
          {ult.name}
        </span>
      </div>
      <div style={{ fontFamily: 'var(--f-ui)', fontSize: 12, color: 'rgba(255,255,255,0.75)', lineHeight: 1.5, marginBottom: 6 }}>
        {ult.description}
      </div>
      <div style={{ fontFamily: 'var(--f-ui)', fontSize: 12, color: 'rgba(255,255,255,0.4)', letterSpacing: 0.5 }}>
